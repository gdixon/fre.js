...
// Switch with new Observables constructed for each test
import { Observable, Switch } from "../../src/fre.js";
...
describe("fre Observable/Merge functionality", function() {
    ...
    // set-up spec testing feature-set
    it("should carry-out the switch method from Observable with synchronous targets", function (done) {
        ...
        const switchd = Switch([target1, target2]).pipe(toArray());
        // expect to match
        const expectation = "[1,2,3,4,1,2,3,4]";
        // place a subscription carry out the work
        switchd.subscribe((message) => {
    ...
    // set-up spec testing feature-set
    it("should carry-out the switch method from Observable with asynchronous targets", function (done) {
        // concat target1 and target1
